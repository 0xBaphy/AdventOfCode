# Advent Of Code - 2020 - [Day 07](https://adventofcode.com/2020/day/7).
### Handy Haversacks
...
- **light red** bags contain `1` **bright white** bag, and `2` **muted yellow** bags.
- **dark orange** bags contain `3` **bright white** bags, and `4` **muted yellow** bags.
- **bright white** bags contain `1` **shiny gold** bag.
- **muted yellow** bags contain `2` **shiny gold** bags, and `9` **faded blue** bags.
- **shiny gold** bags contain `1` **dark olive** bag, and `2` **vibrant plum** bags.
...
plus `2` **vibrant plum** bags (and the `11` bags within **each** of those): `1 + 1*7 + 2 + 2*11` = <code><b>32</b></code> bags!
